...
export default function Home() {
  return <>
    ...
    <main id="conteudo">
      ...
      <section className="instructor section shell" id="professor" aria-labelledby="instructor-title">
        <figure className="instructor-portrait" data-reveal>
          <div className="image-frame"><Image unoptimized src="/images/juliano-pavao-adcc.jpeg" alt="Juliano Pavão em combate sem quimono em um evento ADCC" width={1440} height={1439} loading="lazy" /></div>
          <figcaption className="photo-caption"><span>JULIANO PAVÃO</span><span>EM AÇÃO NO ADCC.</span></figcaption>
        </figure>
        <div className="instructor-copy" data-reveal>
      ...
      <section className="academy section" id="academia">
        <div className="academy-grid shell">
          ...
          <div className="academy-copy" data-reveal><p className="eyebrow light">04 / A ACADEMIA</p><h2>Lá fora, o dia corre.<br />Aqui, você respira.</h2><p>Por um tempo, o que importa cabe no tatame: uma posição, um movimento, a atenção ao parceiro. A prática pede presença. O resto pode esperar um pouco.</p><p>Venha conhecer o espaço e conversar com a equipe. Às vezes, um lugar novo abre espaço para uma nova rotina.</p><a className="cta cta-outline" href={academy.whatsapp} target="_blank" rel="noopener noreferrer">Quero conhecer a academia <ArrowUpRight size={18} aria-hidden="true" /></a><div className="academy-signature"><Image unoptimized src="/images/front39-original.svg" alt="" width="70" height="70" loading="lazy" /><span>UM TEMPO PARA APRENDER.<br />UM LUGAR PARA VOLTAR.</span></div></div>
        </div>
      </section>
      <section className="community section shell" id="comunidade">
        <div className="section-heading" data-reveal><div><p className="eyebrow">05 / COMUNIDADE FRONT39</p><h2>Com o tempo,<br /><span className="muted">os rostos viram histórias.</span></h2></div><div className="community-intro"><p>Um dia, foi a primeira aula de cada pessoa nestas fotos. Depois vieram os treinos, as conversas e os caminhos compartilhados. Toda equipe começa com gente que decidiu chegar.</p><a className="text-link" href={academy.instagram} target="_blank" rel="noopener noreferrer"><Instagram size={17} aria-hidden="true" /> @front39bjj <ArrowUpRight size={18} aria-hidden="true" /></a></div></div>
        <div className="community-gallery community-gallery-expanded">
        <div className="community-shared-moments">
