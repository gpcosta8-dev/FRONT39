...
O banner usa versões WebP da foto original `banner_team.jpg` (6622 × 4415), exportadas com qualidade 82: `banner-team-1920.webp` (1920 × 1280, 176.960 bytes) até 800 px de largura de tela e `banner-team-2880.webp` (2880 × 1920, 370.718 bytes) em telas maiores. O elemento `picture` seleciona um único arquivo; o carregamento é imediato (`eager`) e de alta prioridade. O JPEG original permanece preservado em `public/images/banner-team.jpg`, mas não é solicitado pela página. A imagem mantém o recorte responsivo e a camada escura para leitura. A seção Comunidade usa a foto de graduação em WebP de 1440 × 960, obtida em sua publicação original (https://www.instagram.com/p/DSj2kmtjKQh/?img_index=1), com enquadramento completo. Textos revisados para uma voz mais introspectiva, centrada em recomeço e pertencimento.
